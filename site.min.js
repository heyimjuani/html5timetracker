...
}return false;});$("#done").on("mouseenter","li",function(){$(this).find("p").prepend("<span class='delete'>x</span>");$(this).find(".delete").on("click",function(){var n=$(this).parent().parent().attr("data-task");
