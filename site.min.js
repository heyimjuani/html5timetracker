...
}return false;});$("#done").on("mouseenter","li",function(){$(this).prepend("<span class='delete'>x</span>");$(this).find(".delete").on("click",function(){var n=$(this).parent().attr("data-task");
$(this).parent().remove();localStorage.removeItem(n);});});$("#done").on("mouseleave","li",function(){$(this).find("span.delete").remove();});$("#reset").on("click",function(){$(this).hide();
$(this).siblings("span").show();return false;});$("#actions .confirm").on("click",function(){for(var n in localStorage){if(n==="nextCycle"||n==="cycle"){continue;
